      ...
      <div className="w-full max-w-md">
        ...
        <Card className="border-gray-200 shadow-lg">
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-gray-600">Sign in to your SmartEd account</CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  <input id="remember" type="checkbox" className="rounded border-gray-200" />
                  <Label htmlFor="remember" className="text-sm text-gray-600">
                    Remember me
                  </Label>
                </div>
                <Link href="/forgot-password" className="text-sm text-gray-900 hover:text-black">
                  Forgot password?
                </Link>
              </div>
            ...
            <div className="text-center text-sm text-gray-600">
              ...
              <Link href="/signup" className="text-gray-900 hover:text-black font-medium">
                Sign up
              </Link>
            </div>
          </CardContent>
